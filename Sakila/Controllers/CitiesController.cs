...
namespace Sakila.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(SakilaContext context)
        {
            _context = context;
        }
        ...
        {
            var sakilaContext = _context.City.Include(c => c.Country);
        ...
        {
            ViewData["CountryId"] = new SelectList(_context.Country, "CountryId", "Country1");
            return View();
        }
